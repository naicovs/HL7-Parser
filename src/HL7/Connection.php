 ...
 * </code>
 *
 * The HL7\Connection object represents the tcp connection to the
 * HL7 message broker. The Connection has only two useful methods
 * (apart from the constructor), send and close. The 'send' method
 * takes a HL7\Message object as argument, and also returns a
 * HL7\Message object. The send method can be used more than once,
...
class Connection {
    ...
    /**
     * Sends a HL7\Message object over this connection.
     *
     * @param object Instance of HL7\Message
     * @param string $responseCharEncoding The expected character encoding of the response.
     * @return object Instance of HL7\Message
     * @access public
     * @see HL7\Message
     */
